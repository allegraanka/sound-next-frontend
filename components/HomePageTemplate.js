        ...
        <div className={styles.homePageContainer}>
            ...
            <div className={styles.homePageRightCol}>
                <div className={styles.homePageRightInner}>
                    <p className={styles.homePageRightColGreeting}>A home for the Rochester music scene.</p>
...
export async function getStaticProps() {
  const [shows, posts] = await Promise.all([
    ...
    client.getEntries({ content_type: 'post', 'fields.featured': true, order: '-sys.createdAt', limit: 3 })
  ])
