...
const AboutUs = () => {
    return(
        <div className={styles.aboutComponentContainer}>
            ...
            <p className={styles.aboutComponentText}>More than that, we envision The Sound as a community of close-knit artists united by a strong sense of togetherness and pride for our craft and our city.</p>
